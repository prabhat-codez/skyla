        ...
        try{
            if(!args[0])
              return message.channel.send(new MessageEmbed()
                  ...
                  .setDescription(`Usage: \`${prefix}chatbotsetup <add/remove> <#channel>\``)
              );
            ...
            if(args[0].toLowerCase() === "add") {
              if(client.chatbot.get(message.guild.id, "channels").includes(channel.id))
                return message.channel.send(new MessageEmbed()
                    ...
                    .setDescription(`You can remove it by typing: \`${prefix}chatbotsetup remove <#${channel.id}>\``)
                );
              ...
              if(!client.chatbot.get(message.guild.id, "channels").includes(channel.id))
                return message.channel.send(new MessageEmbed()
                    ...
                    .setDescription(`You can add it by typing: \`${prefix}chatbotsetup add <#${channel.id}>\``)
                );
