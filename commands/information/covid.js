...
module.exports = {
  ...
  usage: "m!covid all/m!covid <country for example canada>",
  category: "info",
  ...
  run: async (Client, message, args) => {
    ...
    const noArgs = new Discord.MessageEmbed()
      ...
      .setColor(0xFF0000)
      .setDescription('You Can Try Using **`m!covid/corona all`** or **`m!covid/corona <country, for example canada>`**')
    // sends the noArgs embed
    if (!args[0]) return message.channel.send(noArgs);
    console.log(`${message.author.username} dont know how to use this command in ${message.guild.name}`)
      ...
      fetch(`https://covid19.mathdro.id/api`)
        ...
        .then(data => {
          ...
          const embed = new Discord.MessageEmbed()
            ...
            .addField('<:covid:910785843277479936> Confirmed Cases', confirmed)
